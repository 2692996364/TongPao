...
public class SculptFragment extends BaseFragment<DiscoverPresenter> implements IDiscover.View {
    ...
    private HotspotAdapter sculptAdapter;
    ...
    public void initView() {
        ...
        sculptAdapter = new HotspotAdapter(getContext(), listBeans);
        recycler_discover_hotspot.setLayoutManager(new LinearLayoutManager(getContext()));
        recycler_discover_hotspot.setAdapter(sculptAdapter);
    ...
    public void getSculpt(DiscoverTLBean result) {
        ...
        sculptAdapter.notifyDataSetChanged();
    }
