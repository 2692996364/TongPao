...
//        initCluster();
    ...
    private void initView() {
        ...
        btnDbx.setOnClickListener(this);
    }
    ...
    private void btndbx(){
        ...
        String word = inputA.getText().toString();
...
//                drawCircle(poiInfo.location.latitude, poiInfo.location.longitude);
                ...
                MapStatusUpdate statu = MapStatusUpdateFactory.newLatLngZoom(latLng, 20);
                baiduMap.setMapStatus(statu);
//                TextOptions position = new TextOptions()
//                        .text(poiInfo.name)
//                        .bgColor(0xAAFFFF00)
//                        .fontSize(22)
...
//                baiduMap.addOverlay(position);
                ...
                /*
                //初始化点聚合管理类
                myItemClusterManager = new ClusterManager<>(MapActivity.this, baiduMap);
    ...
    OnGetRoutePlanResultListener routePlanResultListener = new OnGetRoutePlanResultListener() {
        ...
        public void onGetWalkingRouteResult(WalkingRouteResult walkingRouteResult) {
            ...
            if(walkingRouteResult.getRouteLines() != null && walkingRouteResult.getRouteLines().size() > 0){
                ...
                //当前的定位移动到开始点并放大地图
                MapStatusUpdate status = MapStatusUpdateFactory.newLatLngZoom(startLatLng,20);
                baiduMap.setMapStatus(status);
            }else{
